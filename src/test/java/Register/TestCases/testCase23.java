...
public class testCase23 extends baseTest {
    ...
    @Test(dataProvider = "singUpPageData", priority = 10)
    public void verifyCartDeliveryBillingAddressTest(String day, String month, String year, String first_name,
                                      String last_name, String password,
                                      String address, String country, String state,
                                      String city, String zip, String phoneNum) {
        ...
        Assert.assertEquals(address, checkPage.getBillingAddress());
    }
